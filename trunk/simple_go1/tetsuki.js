...
goWindow(int)
/* tetsuki view */
document.getElementById("close_small")
document.getElementById("back_small")
document.getElementById("forward_small")
document.getElementById("delete_small")
document.getElementById("more_small")
document.getElementById("pass_small")
document.getElementById("board9")
document.getElementById("board13")
document.getElementById("board19")
document.getElementById('board9')
document.getElementById('board13')
document.getElementById('komi')
document.getElementById('black_ai')
document.getElementById('white_ai')
document.getElementById('handicap')
document.getElementById('ingameblack')
document.getElementById('ingamewhite')
document.getElementById('ingamekomi')
document.getElementById("gameHud")
document.getElementById('beginWindow')
document.getElementById('GameWindow')
document.getElementById('InGameSettings')
document.getElementById('meta')
document.getElementById('ingameblack')
document.getElementById('ingamewhite')
document.getElementById('ingamehandicap')
document.getElementById('ingamekomi')
